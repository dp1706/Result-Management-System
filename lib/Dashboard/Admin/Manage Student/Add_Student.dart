                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          prefixIcon: Icon(Icons.details,color: Colors.blueAccent,),
                          border: new OutlineInputBorder(
                            borderRadius: new BorderRadius.circular(25.0),
                            borderSide: new BorderSide(),
                          ),
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          prefixIcon: Icon(Icons.chat_bubble_outline_rounded,color: Colors.blueAccent,),
                          border: new OutlineInputBorder(
                            borderRadius: new BorderRadius.circular(25.0),
                            borderSide: new BorderSide(),
                          ),
                    ...
                    FlatButton(
                        ...
                        onPressed: () async {
                            if (_key.currentState.validate()) {
                                bool value = await database.createNewUser(_name.text,_email.text,_branch.text,_course.text,_roll.text,_pass.text,_batch.text);
                                if(value){
                                  _showMyDialog();
                                }
                                else{
                            ...
                            for (var table in excel.tables.keys) {
                              ...
                              for (var row in excel.tables[table].rows) {
                                if(i==0){
                                  ...
                                  bool value = await database.createNewUser(list[1].toString(), list[2].toString(), list[3].toString(), list[4].toString(), list[5].toString(), list[6].toString(),list[7].toString());
                                  if(value){
                                     _showMyDialog();
                                  }
                                  else{
                      ...
                      child: Table(
                          ...
                          children: [
                            TableRow(children :[
                              ...
                              Text('Batch',style: TextStyle(fontSize: 14.0),textAlign: TextAlign.center),
                            ...
                            TableRow(children :[
                              ...
                              Text('2018',style: TextStyle(fontSize: 14.0),textAlign: TextAlign.center),
