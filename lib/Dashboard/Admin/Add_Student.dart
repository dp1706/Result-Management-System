                        ...
                        onPressed: () async {
                          setState(() {
                            if (_key.currentState.validate()) {
                              try{
                                Future<bool> value = database.createNewUser(_name.text,_email.text,_branch.text,_course.text,_roll.text,_pass.text,_batch.text);
                                _showMyDialog();
                              }catch(e){
                                print(e);
                              }
                            ...
                            for (var table in excel.tables.keys) {
                              ...
                              for (var row in excel.tables[table].rows) {
                                if(i==0){
                                  ...
                                  database.createNewUser(list[1].toString(), list[2].toString(), list[3].toString(), list[4].toString(), list[5].toString(), list[6].toString(),list[7].toString());
                                }
