...
import 'TeacherCourseDetails.dart';
                    ...
                    child: Card(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          Text('Add Result', style: TextStyle(fontSize: 20,),),
                        ],
                      ),
                    ),
                  ),
                    ...
                    child: Card(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          Image.asset("images/notepad.png",height: 70 ,width:40,color: Colors.pinkAccent,),
                          Text('Final Result', style: TextStyle(fontSize: 20,),),
                        ],
                      ),
                    ),
                  ),
                  ...
                  GestureDetector(
                    onTap: () {
                      setState(() {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) =>TeacherCourseDetails()),
                        );
                      });
                    },
