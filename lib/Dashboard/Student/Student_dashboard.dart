...
import 'Current_Sem_Result.dart';
import 'Previous_Sem_Result.dart';
...
import 'Contact.dart';
import 'StudentCourseDetails.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context){
    ...
    return WillPopScope(
      ...
      GestureDetector(
                 onTap: () {setState(() {Navigator.push(context, MaterialPageRoute(builder: (context) => StudentCourseDetails()),);});},
            child: Card(
              shape: RoundedRectangleBorder(
                borderRadius:  BorderRadius.circular(15),
              ),
